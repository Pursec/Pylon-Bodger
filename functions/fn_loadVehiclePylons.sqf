...
_index = 0;
{
	...
	VEHICLEPYLONS lbAdd format["(%1) %2 : %3", _pylonIndex, _pylonName, _pylonCurrentMagazine];
	VEHICLEPYLONS lbSetData[_index, _pylonName];
	VEHICLEPYLONS lbSetTooltip[_index, format["(%1) %2 : %3", _pylonIndex, _pylonName, _pylonCurrentMagazine]];
